...
public class MainMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutBtn.setOnClickListener(v -> {
            ...
            startActivity(new Intent(getApplicationContext(),Forum.class)); //Change Forum.class to Login.class
        });
        ...
        forumBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(MainMenu.this, "Switched to Forum", Toast.LENGTH_SHORT).show();
            Intent a = new Intent(MainMenu.this, Forum.class);
            startActivity(a);
        });

        //This will switch to the report occurence page when btn is clicked
        reportBtn.setOnClickListener(v -> {
            Toast.makeText(MainMenu.this, "Switched to Report Occurence Page", Toast.LENGTH_SHORT).show();
        ...
        editProBtn.setOnClickListener(v -> {
            Toast.makeText(MainMenu.this, "Switched to Edit Profile page", Toast.LENGTH_SHORT).show();
